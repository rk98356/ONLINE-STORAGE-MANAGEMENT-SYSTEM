...
//		$mail->SMTPDebug = 4;                               // Enable verbose debug output
		...
		$mail->Username = 'rk98356@gmail.com';                 // SMTP username
		$mail->Password = 'shivshankar';                           // SMTP password
		$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
		$mail->Port = 587;                                    // TCP port to connect to

		$mail->setFrom('rk98356@gmail.com', 'rk98356@gmail.com');
...
<body>
	<div class="container-fluid">
		...
		//    echo 'Mailer Error: ' . $mail->ErrorInfo;
		    ...
		    echo 'You Registered Successfully Check your email for password!';
		}
	}
	else {
