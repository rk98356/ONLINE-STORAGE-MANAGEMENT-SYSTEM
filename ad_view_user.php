...
<?php      $query ="SELECT * FROM `user_details` ";
       ...
       echo'<tr>
                ...
                <td>'.$row["email"].'</td>
                <td>'.$row["mobile_no"].'</td>
                <td><a href="#" class="view_user" data-toggle="modal" style="color:rgb(0,0,51);" data-id="'.$row['email'].'" data-sno="'.$row['s_no'].'" data-but="#viewuser" data-page="view">View Details</a>  </td>
            </tr>';
            $s_no++;}
