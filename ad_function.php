...
function profile($user_id,$page){
        ...
        echo '<div class="row " style="padding: 10px; border-bottom: 2px solid rgb(0,0,51);">
                <div class="col-sm-2" align="center">
                    <img src="img/Picture.bmp" style="height: 85px; border-radius: 600px; border:1px solid rgb(0,0,51);">
                </div>
                <div class="col-sm-4">
        ...
        $row = mysqli_fetch_array($result);
              echo' <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-md-8 card" >
                            <h3 class="card-header">Storage Detail...</h3>
                            <p class="list-group list-group-item">
                            <label><b>Super User:</b></label>
                            <label>'.$row['added_by'].'</label></p>
                            
                            <p class="list-group list-group-item">
                            <label><b>Storage Assigned:</b></label>
                            <label>'.$row['disk_usage'].'</label>
                            
                            <p class="list-group list-group-item">
                            <label><b>Premium:</b></label>
                            <label>'.$row['premium'].'</label>
              ...
              echo' <form method="post" id="update_user_details_form">
                    <div class="row" style="margin-top: 10px; padding:0px 10px 0px 10px"> 
                        ...
                        <div class="col-md-8 card" >
                            ...
                            <p class="list-group list-group-item">
                            <label><b>Premium:</b></label>
                            <input type="text" placeholder="Premium User..." class="form-control" required="true" id="update_address" value="'.$row['premium'].'" />
                            </p>
                            <p class="list-group list-group-item">
                            <label><b>Moblie.No:</b></label>
