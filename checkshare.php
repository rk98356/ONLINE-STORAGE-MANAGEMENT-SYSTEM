        ...
        <div class="row" style="margin-top: 5%;height:75vh;">
          ...
          <form class="col-md-10 container-fluid" action="#" enctype="multipart/form-data" style="background: #fff; color:rgb(0,0,51); margin-bottom:100px; padding-bottom:15px;">
            <div class="row" style="border-bottom: 2px solid rgb(0,0,51);">
              <div class="col-md-3"><i class="fa fa-share" aria-hidden="true"></i> &nbsp;<b>Share With Me</b></div>
    ...
    <div class="row">
            ...
            foreach($ffs as $ff){
              ...
              if($type=='Files'){
                if(!is_dir($dir.'/'.$ff)){  
                  ...
                  {
                    echo '<div class="col-sm-4 box" style="font-family:Times New Roman, Times, serif;"><div class="inner_box "><span style="cursor:pointer;"><span class="fa fa-file-audio-o file" path="'.$dir.'/'.$ff.'" dir="'.$dir.'"  style="color:#fff;"></span><br/><span title="File Name - '.$ff.',('.filesize_formatted($dir.'/'.$ff).'), Created on '.date('d-m-Y',strtotime(filectime($dir.'/'.$ff))).'">'.substr($ff, 0, 10).'...</div></div><br/>';
      ...
      <div class="col-md-4" id="show_file">
        ...
        if(isset($_POST['file'])){
          ...
          echo "<a href='checkshare.php'><span class='pull-right' style='font-size:20px;padding:8px;'>&times;</span></a><h3 style='font-family:Times New Roman, Times, serif;text-align:center;' class='section-title'>".substr((basename($_POST['file'], '?' . $_POST['file'])),0,15)."...</h3><hr/>";  
          $file = $_POST['file'];
          if($ext =="png" || $ext == "jpg"|| $ext == "jpeg" || $ext == "gif"|| $ext == "bmp"){
            echo "<img src='".$file."' class='img-responsive trydata'/>";
            echo "File Type:";
