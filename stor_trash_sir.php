    ...
    <div class="row">
        ...
        function listFolderFiles($dir, $type){
          ...
          $idshowit=1;
            ...
            foreach($ffs as $ff){
                ...
                $query = "SELECT * FROM users WHERE `folder_name`='uploads/".$_SESSION['user_id'].'/'.$ff."' AND `trashed` ='1'";
                //echo $query;
                ...
                if($flag > 0){
                      echo'<div class="col-sm-4 box " style="font-family:Times New Roman, Times, serif;">
                        <div class="inner_box" data-element="'.$idshow.'">
                        <span style="float:right;">
                          <a class="move_to_trash" type="button" data-path="'.$ff.'" data-type="folder" data-trash="0" data-element="'.$idshow.'"><i class="fa fa-undo" style="font-size:16px"></i></a>
                          </span>
              ...
              if($type=='Files'){
                if(!is_dir($dir.'/'.$ff)){  
                  ...
                  $con = mysqli_connect("localhost","root","","task_management");
                  $query = "SELECT * FROM `users` WHERE `image`='".$dir.'/'.$ff."' AND `trashed`='1' ";
                  //echo $query;
                  $result= mysqli_query($con,$query);
                  if(mysqli_num_rows($result) > 0){
                  ...
                  else if($ext =='mp3' || $ext == 'wav' || $ext == 'wma')
                  {
                    if($row['trashed']==1){
                    echo '<div class="col-sm-4 box" style="font-family:Times New Roman, Times, serif;" data-element="'.$idshowit.'"><div class="inner_box "> <span style="float:right;">
                        <a class="move_to_trash" type="button" data-path="'.$row['image'].'" data-trash="0" data-element="'.$idshowit.'" ><i class="fa fa-undo" style="font-size:16px"></i></a>
      ...
      <div class="col-md-4" id="show_file">
        ...
        if(isset($_POST['file'])){
          ...
          echo "<a href='stor_trash.php'><span class='pull-right' style='font-size:20px;padding:8px;'>&times;</span></a><h3 style='font-family:Times New Roman, Times, serif;text-align:center;' class='section-title'>".substr((basename($_POST['file'], '?' . $_POST['file'])),0,15)."...</h3><hr/>";  
          $file = $_POST['file'];
          if($ext =="png" || $ext == "jpg"|| $ext == "jpeg" || $ext == "gif"|| $ext == "bmp"){
            echo "<img src='".$file."' class='img-responsive trydata'/>";
            echo "File Type:";
